...
import com.beiair.net.business.homer.QueryWeatherPair.RspQueryWeather.Weatherinfo;
...
import com.beiair.ui.activity.AddCityActivity;
...
public class WeatherView extends RelativeLayout implements View.OnClickListener {
	...
	WeatherLoadListener loadListener;
	...
	private void getCurCityWeather() {
		String curCity = new DB_Location(BeiAirApplaction.getInstance())
				.getCurCity();
		if (TextUtils.isEmpty(curCity)) {
			new LocationUtils().startLocation(
					BeiAirApplaction.getInstance(),
		...
		if (weather.data != null) {
			...
			if (weatherinfo != null) {
				if (loadListener != null){
					loadListener.onSucess(weatherinfo);
				}
	...
	public interface WeatherLoadListener{
		void onSucess(Weatherinfo weatherinfo);
	}
