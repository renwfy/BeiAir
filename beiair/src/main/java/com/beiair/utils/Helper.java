...
public class Helper {
	...
	public static boolean checkFileName(String sInput) {
		...
		for (int i = 0; i < sInput.length(); i++) {
			if (cInput[i] != '0' && cInput[i] != '1' && cInput[i] != '2' && cInput[i] != '3' && cInput[i] != '4' && cInput[i] != '5'
					&& cInput[i] != '6' && cInput[i] != '7' && cInput[i] != '8' && cInput[i] != '9' && cInput[i] != 'a' && cInput[i] != 'b'
					&& cInput[i] != 'c' && cInput[i] != 'd' && cInput[i] != 'e' && cInput[i] != 'f' && cInput[i] != 'g' && cInput[i] != 'h'
					&& cInput[i] != 'i' && cInput[i] != 'j' && cInput[i] != 'k' && cInput[i] != 'l' && cInput[i] != 'm' && cInput[i] != 'n'
					&& cInput[i] != 'o' && cInput[i] != 'p' && cInput[i] != 'q' && cInput[i] != 'r' && cInput[i] != 's' && cInput[i] != 't'
					&& cInput[i] != 'u' && cInput[i] != 'v' && cInput[i] != 'w' && cInput[i] != 'x' && cInput[i] != 'y' && cInput[i] != 'z'
					&& cInput[i] != 'A' && cInput[i] != 'B' && cInput[i] != 'C' && cInput[i] != 'D' && cInput[i] != 'E' && cInput[i] != 'F'
					&& cInput[i] != 'G' && cInput[i] != 'H' && cInput[i] != 'I' && cInput[i] != 'J' && cInput[i] != 'K' && cInput[i] != 'L'
					&& cInput[i] != 'M' && cInput[i] != 'N' && cInput[i] != 'O' && cInput[i] != 'P' && cInput[i] != 'Q' && cInput[i] != 'R'
					&& cInput[i] != 'S' && cInput[i] != 'T' && cInput[i] != 'U' && cInput[i] != 'V' && cInput[i] != 'W' && cInput[i] != 'X'
					&& cInput[i] != 'Y' && cInput[i] != 'Z' && cInput[i] != '.' && cInput[i] != '_') {
				checkedValue = false;
			}
		}
		return checkedValue;
	...
	public static byte ConvertIntTo1byteHexaFormat(int numberToConvert) {
		return (byte) (numberToConvert & 0xFF);
	}
	...
	// int数据，转4字节
	// ***********************************************************************/
	public static byte[] ConvertIntTo4bytesHexaFormat(int numberToConvert) {
		byte[] ConvertedNumber = new byte[4];
		ConvertedNumber[0] = (byte) ((numberToConvert >> 24) & 0xFF);
		ConvertedNumber[1] = (byte) ((numberToConvert >> 16) & 0xFF);
		ConvertedNumber[2] = (byte) ((numberToConvert >> 8) & 0xFF);
		ConvertedNumber[3] = (byte) (numberToConvert & 0xFF);
	...
	// 4字节 转int数据
	// ***********************************************************************/
	public static int Convert4bytesHexaFormatToInt(byte[] ArrayToConvert) {
		
		/*int ConvertedNumber = 0;
		ConvertedNumber += (int) ((int) ArrayToConvert[0] << 24);
		ConvertedNumber += (int) ((int) ArrayToConvert[1] << 16);
		ConvertedNumber += (int) ((int) ArrayToConvert[2] << 8);
		ConvertedNumber += (int) (ArrayToConvert[3]);*/
		
		int ConvertedNumber = (hexadeToDecimal(ArrayToConvert[0])) * 256 * 256 * 256 + hexadeToDecimal(ArrayToConvert[1]) * 256 * 256
				+ hexadeToDecimal(ArrayToConvert[2]) * 256 + hexadeToDecimal(ArrayToConvert[3]);
		return ConvertedNumber;
	}
	...
	public static int hexadeToDecimal(byte hex) {
		String sixString = String.format("%1$02x", hex);
		return Integer.parseInt(sixString, 16);
	}
