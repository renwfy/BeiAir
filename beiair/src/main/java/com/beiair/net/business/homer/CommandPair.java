...
import com.beiair.net.business.homer.CommandPair.ReqCommand;
import com.beiair.net.business.homer.CommandPair.RspCommand;
...
public class CommandPair extends AbsSmartNetReqRspPair<ReqCommand, RspCommand> {
	...
	public static class ReqCommand extends AbsReqMsg {
		...
		public String getReqMethod() {
			...
			return ServerDefinition.APIServerMethod.HOMER_Command.getMethod();
		}
	}
