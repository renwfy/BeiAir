...
import com.beiair.net.business.homer.GetDevInfoPair.ReqGetDevInfo;
import com.beiair.net.business.homer.GetDevInfoPair.RspGetDevInfo;
...
public class GetDevInfoPair extends AbsSmartNetReqRspPair<ReqGetDevInfo, RspGetDevInfo>{
	...
	public static class ReqGetDevInfo extends AbsReqMsg {
		...
		public String getReqMethod() {
			...
			return ServerDefinition.APIServerMethod.HOMER_GetDevice.getMethod();
		}
	}
